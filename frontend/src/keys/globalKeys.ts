...
// 工具→键位（当前 IMT 工具集；SDD 04 落地后由工具声明携带，此常量迁移，见 D-2）。
const TOOL_KEYS: Record<string, Tool> = { v: "cursor", l: "editli", m: "editma", r: "roi" };
...
export const SHORTCUT_ROWS: ShortcutRow[] = [
  ...
  { group: "tool", keys: "L", label: "tl_editli" },
  { group: "tool", keys: "M", label: "tl_editma" },
  { group: "tool", keys: "R", label: "tl_roi" },
