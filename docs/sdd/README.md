...
| 01 | [双模式外壳 Focus / Workbench](feats/01-dual-mode-shell/README.md) | `implemented`（v1.4 舞台常驻分栏 `ready` 待实现；v1.3 栏宽可拖拽；v1 `accepted`） | Glaux 项目维护者 | 2026-08-30 |
...
| 08 | [数据导入优先的文件栏](feats/08-data-import-first-explorer/README.md) | `ready` | Glaux 项目维护者 | 2026-08-30 |
